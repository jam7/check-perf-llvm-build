...
## LLVM ビルド性能比較結果
実行日時: 2026-02-16 14:22:27

ビルドタイプ: `Debug`, コンパイルスレッド数: 12, リンクスレッド数: 1, on SX-Aurora

| 環境 | リンク方式 | cmake (秒) | build (秒) | check-llvm (秒) | check-clang (秒) | 合計 (秒) |
|------|-----------|------------|-----------|-----------------|------------------|----------|
| centos7 | static | 64 | 2976 | 618 | 859 | 4517 |
| centos7 | dso1 | 80 | 2197 | 512 | 996 | 3785 |
| centos7 | dso2 | 54 | 2222 | 666 | 848 | 3790 |
